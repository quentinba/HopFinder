...
| **10** | **E3 ✅ fait le 2026-09-11** — E5/E6 **en attente d'arbitrage** | E3 : chip « Top N all tied at X » quand les houblons affichés sont simplement ex æquo (le cas normal en mode Descriptors). E5 (navigation à 10 modes) et E6 (mobile) restent ouverts : ils changent l'usage, et `st.navigation`/`st.Page` comme le repli « deux radios groupés » ont déjà été essayés et écartés pour des raisons documentées — à trancher avant d'y retoucher. | `app.py` | E3 : nul. E5/E6 : moyen. |
