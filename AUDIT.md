...
| **9** | **C5 : épingler les dépendances** | Protège la prod | `pyproject.toml` | Faible. |
| **10** | **E3/E5/E6 (paliers, navigation, mobile)** | Ergonomie de fond | `app.py` | Moyen — à discuter avant. |
